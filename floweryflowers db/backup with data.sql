...
--
-- Temporary view structure for view `customeroverview`
--

DROP TABLE IF EXISTS `customeroverview`;
/*!50001 DROP VIEW IF EXISTS `customeroverview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `customeroverview` AS SELECT 
 1 AS `fname`,
 1 AS `lname`,
 1 AS `email`,
 1 AS `phone`*/;
...
--
-- Temporary view structure for view `supplierproduct`
--

DROP TABLE IF EXISTS `supplierproduct`;
/*!50001 DROP VIEW IF EXISTS `supplierproduct`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `supplierproduct` AS SELECT 
 1 AS `supplierName`,
 1 AS `productID`,
 1 AS `productName`*/;
SET character_set_client = @saved_cs_client;
...
/*!50001 VIEW `customerorderview` AS select `c`.`fname` AS `fname`,`c`.`lname` AS `lname`,`o`.`orderDate` AS `orderDate`,`o`.`totalAmount` AS `TotalAmount` from (`customers` `c` join `orders` `o` on((`c`.`customersID` = `o`.`customerID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `customeroverview`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `customeroverview` AS select `customers`.`fname` AS `fname`,`customers`.`lname` AS `lname`,`customers`.`email` AS `email`,`customers`.`phone` AS `phone` from `customers` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productinventory` AS select `p`.`productID` AS `productID`,`p`.`productName` AS `productName`,`i`.`quantity` AS `quantity`,`p`.`price` AS `price` from (`products` `p` join `inventory` `i` on((`p`.`productID` = `i`.`productID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productprice` AS select `products`.`productID` AS `productID`,`products`.`productName` AS `productName`,`products`.`price` AS `price`,`CalculateDiscountedPrice`(`products`.`productID`) AS `discountedPrice` from `products` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `supplierproduct`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `supplierproduct` AS select `s`.`supplierName` AS `supplierName`,`p`.`productID` AS `productID`,`p`.`productName` AS `productName` from (`supplier` `s` join `products` `p` on((`s`.`supplierID` = `p`.`supplierID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-02-25 19:47:51
